...
// Replaces the old inline, admin-typed "Other Attractions" list (a simple
// 5-field RepeatableList embedded directly in MuseumForm.tsx). Every card
...
// visually identical to the museum's own tickets, matching visit-museums.
    ...
    <section className="border-t border-gray-100 bg-[#FBFBFA] py-16 sm:py-20">
      <div className="mx-auto max-w-[1140px] px-4 sm:px-6">
        <div className="mx-auto mb-10 max-w-2xl text-center">
          ...
          <h2 className="mt-3 font-serif text-2xl sm:text-3xl font-bold tracking-tight text-[#182220]">
