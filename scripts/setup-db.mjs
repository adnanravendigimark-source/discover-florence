...
async function main() {
  ...
  if (SHOULD_SEED) {
    ...
    console.log(
      "\nSkipping sample-content seeding (schema/migration only). Run with --seed to also seed the real launch content (Duomo Florence, Uffizi Gallery, Accademia Gallery, Ponte Vecchio, Palazzo Vecchio, Boboli Gardens) into empty tables."
    );
  }

  console.log("\nDone. Discover Florence database is ready.");
  console.log(
