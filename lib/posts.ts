...
const DEFAULT_CTA_HEADING = "Ready to explore Florence?";
const DEFAULT_CTA_BODY = "Compare skip-the-line tickets, guided Dome climb passes, and museum tours for Florence's top attractions.";
const DEFAULT_CTA_BUTTON_TEXT = "Browse Florence Tickets";
const DEFAULT_CTA_BUTTON_HREF = "/#attractions";
const DEFAULT_AUTHOR = "Discover Florence Editorial Team";
...
function seedToPost(seed: any): Post {
  return {
    ...
    focusKeyword: seed.focusKeyword || "Discover Florence",
...
function rowToPost(row: any): Post {
  ...
  return {
    ...
    focusKeyword: row.focus_keyword || "Discover Florence",
