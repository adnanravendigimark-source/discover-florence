...
const DEFAULT_PRIVACY_POLICY: PrivacyPolicy = {
  ...
  noFollow: false,
  canonicalUrl: "",
  metaTitle: "Privacy Policy | Discover Florence",
  metaDescription: "Privacy Policy for Discover Florence — how we protect your information when comparing Florence attraction and museum tickets.",
  ogTitle: "",
  ogDescription: "",
  ogImage: "",
};
