...
// Matches the visit-museums reference card: compact proportions, rating
// as a small pill overlaid on the photo instead of its own footer row,
// and price + the booking button sharing one row instead of three stacked
// blocks (title / price / button / rating). Nothing was removed — ribbon,
// price, was-price, duration, description, includes, rating, reviews, and
// the button are all still shown, just laid out more efficiently.
export default function TourCard({
  ...
  // Render the admin's Description field on the card (clamped to 2 lines),
  // matching its own admin hint. Guarded against empty HTML (e.g. "<p></p>")
